...
def meilleurDispo( L, M ) :
    ...
    #
    #
    # Les 6 lignes suivanes sont a retirer avant la remise. De manière générale, retirez tout affichage superflu
    # print ""
    # print "État des matrices à l'initilisation : "
    # print "W = "
    # print W
    # print "N = "
    # print N

    # Conseil : remplir les lignes une par une et pour chaque ligne remplir les
    # colonnes en ordre croissant.
  ...
  #  on utilise à la fin la matrice N pour reconstituer la disposition optimale trouvée
    ...
    # Les 4 lignes qui suivent remplissent la matrice avec des valeurs bidons.
    # Ces valeurs font en sorte qu'on affichera un seul mot par ligne.
    # Remplacez ceprogrammers lignes par le code permettant un affichage optimal.
    for i in range( 2, n+1 ) :
        for j in range( 1, n+1 ) :
            W[i,j] = INFINI

    for i in range( 2, n+1 ) :
        # print "calcul pour la ligne ", i
        for j in range( 1, n+1 ) :
            # print "    colonne ", j
            mini = INFINI # pénélité minimale pour j mots sur i lignes
            a_optimal = 0 # nombre de mots sur la dernière lignes pour obtenir la pénalité minimale
            for a in range( 0, j ) :
                # print " ; j = ", a, " + ", j-a,
        ...
        # c'est qu'on a dépassé le nombre de lignes optimal
				# inutile donc de continuer.
        if (W[i,n] > W[i-1,n]) :
            break
    #W[n,n] = 0 

    # Les 6 lignes suivantes sont à retirer
    # print ""
    # print "État des matrices après optimisation :"
    # print "W = "
    # print W
    # print "N = "
    # print N
